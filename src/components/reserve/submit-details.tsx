        ...
        <div className="space-y-6 flex-1">
          <div className="grid grid-cols-2 gap-6">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel htmlFor="firstName" className="text-black">
                    Enter First Name
                  </FormLabel>
                  <FormControl>
                    <Input
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel htmlFor="lastName" className="text-black">
                    Enter Last Name
                  </FormLabel>
                  <FormControl>
                    <Input
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel htmlFor="mobile" className="text-black">
                    Enter Mobile
                  </FormLabel>
                  <FormControl>
                    <Input
            ...
            <FormField
              ...
              render={({ field: { ref, onChange, ...rest } }) => (
                <FormItem className="flex items-center gap-x-2">
                  <FormControl>
                    <Checkbox
                      className="cursor-pointer m-0 text-black"
