    ...
    <div className="flex flex-col container mx-auto px-4 md:px-0 py-12">
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 md:pl-8 mt-4 md:mt-0">
          ...
          <div className="text-4xl font-bold my-4 w-full border border-slate-200 flex justify-center items-center rounded-xl py-12 text-black">
            Our Price:{" "}
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {features(props).map(({ id, icon, label }) => (
              ...
              >
                {icon}
                <p className="text-sm font-medium mt-2 text-black">{label}</p>
              </div>
            ))}
          </div>
        </div>
